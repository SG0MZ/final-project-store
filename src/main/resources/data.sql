...
INSERT INTO course (course_name, description, domain, price) VALUES('Full Stack Development','Contains Microservices, Springboot, SQL','Programming',100.0);
INSERT INTO course (course_name, description, domain, price) VALUES('English Advanced with Certification','Complete english course, includes certification','Language',85.0);
INSERT INTO course (course_name, description, domain, price) VALUES('Guitar Course for Beginners','Full guitar course for beginners','Music',90.0);
